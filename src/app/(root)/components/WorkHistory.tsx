...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    imageUrl:
      "https://xrqb2mg56u.ufs.sh/f/DbWOBxCL0tnlzlyDfhMpquRNMztrJOhx8BUkwCIHsV64TZAj",
  ...
  },
  {
    ...
    company: "Sweep",
    imageUrl:
      "https://xrqb2mg56u.ufs.sh/f/DbWOBxCL0tnlRUxw9BQWU7S1ANbaLGOvYK8t4rxizndTBemP",
    title: "Software Engineering Intern",
    description: [
  ...
  },
  {
    ...
    imageUrl:
      "https://xrqb2mg56u.ufs.sh/f/DbWOBxCL0tnlAre0uMacof4RtzrDZivg1dLkeU02nhawylSE",
    title: "Software Engineering Intern",
    description: [
...
export default function WorkHistory() {
  return (
    <div className="flex flex-col p-7 gap-7 rounded-xl border-1 border-gray-300 dark:border-neutral-800">
