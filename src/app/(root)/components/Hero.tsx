...
export default function Hero() {
  ...
  const downloadResume = async () => {
    const response = await fetch(
      "https://xrqb2mg56u.ufs.sh/f/DbWOBxCL0tnlzlgAEElpquRNMztrJOhx8BUkwCIHsV64TZAj"
    );
  ...
  return (
    <section className="flex flex-col-reverse w-full gap-4 sm:flex-row sm:gap-2">
      <div className="flex flex-col sm:w-2/3 gap-3 sm:gap-8">
        ...
        <div className="flex flex-row items-center gap-5">
          ...
          <a href="https://www.linkedin.com/in/jballo/" target="_blank">
            {theme === "dark" ? (
              <LinkedIn height={25} width={25} fill="white" />
            ) : (
          ...
          <a href="https://github.com/jballo" target="_blank">
            {theme === "dark" ? (
              <GitHub height={25} width={25} fill="white" />
            ) : (
      ...
      <div className="flex flex-row sm:justify-end items-center sm:w-1/3">
        <Image
